app.register.controller('activityGYYController', function ($rootScope, $scope, httpRequest, dataStringify, signSha1, analytics, $location, $window, $routeParams) {
    ...
    var imgUrl="http://goeasy.yhiker.com/image/activity/gyy/1.jpg";
    var title="购轻松台湾";
    var desc="郭元益";
...
app.register.controller('nationalDayController', function ($rootScope, $scope, httpRequest, dataStringify, signSha1, analytics, $location, $window, $routeParams) {
    $scope.isShowNavbar=false;
    $scope.isApp=isApp($location);
    $scope.isShowNavbar=$scope.isApp?false:true;
