...
app.config(function ($routeProvider, $locationProvider,$controllerProvider,$compileProvider,$filterProvider,$provide) {
    ...
    $routeProvider
		...
		.when('/app/shuttleService', { controller:"shuttleServiceController",templateUrl: "views/app/shuttleService.html?"+preventCache
			,resolve: {
				load: app.asyncjs('js/controller/app/apppages.js')
			}
		})
		...
		/*活动 **/
		.when('/activity/activity01', { templateUrl: "views/activity/activity-01.html?"+preventCache 
			  ,resolve: {
				load: app.asyncjs('js/controller/activity/activity.js')
			  }
		})		
		.when('/activity/activityDetail', { templateUrl: "views/activity/activity201501.html?"+preventCache,controller:'activity201501Controller' 
			  ,resolve: {
				load: app.asyncjs('js/controller/activity/activity.js')
			  }
		})
		.when('/activity/activityDown', { templateUrl: "views/activity/down.html?"+preventCache,controller:'activityDownController' 
			  ,resolve: {
				load: app.asyncjs('js/controller/activity/activity.js')
			  }
		})
		...
		.when('/activity/guide', { templateUrl: "views/activity/guide.html?"+preventCache 
			  ,resolve: {
				load: app.asyncjs('js/controller/activity/activity.js')
			  }
		})
		...
		.when('/activity/xbl', { templateUrl: "views/activity/xbl.html?"+preventCache 
			  ,resolve: {
				load: app.asyncjs('js/controller/activity/activity.js')
			  }
		})
		.when('/taxFreeStore', { templateUrl: "views/activity/taxFreeStore.html?"+preventCache })
		
		.when('/activity/activityDetail/:id', { templateUrl: "views/activity/activity201501.html?"+preventCache,controller:'activity201501Controller' 
			  ,resolve: {
				load: app.asyncjs('js/controller/activity/activity.js')
			  }
		})
		.when('/activity/activityDetail/:id/:type', { templateUrl: "views/activity/activityDetail.html?"+preventCache,controller:'activityDetailController' 
			  ,resolve: {
				load: app.asyncjs('js/controller/activity/activity.js')
			  }
		})
		.when('/activity/mothersDay', { templateUrl: "views/activity/mothersDay.html?"+preventCache 
			  ,resolve: {
				load: app.asyncjs('js/controller/activity/activity.js')
			  }
		})
		.when('/activity/beautySummer', { templateUrl: "views/activity/beautySummer.html?"+preventCache 
			  ,resolve: {
				load: app.asyncjs('js/controller/activity/activity.js')
			  }
		})
		.when('/activity/may', { templateUrl: "views/activity/may.html?"+preventCache 
			  ,resolve: {
				load: app.asyncjs('js/controller/activity/activity.js')
			  }
		})
		.when('/activity/xblnew', { templateUrl: "views/activity/xblnew.html?"+preventCache 
			  ,resolve: {
				load: app.asyncjs('js/controller/activity/activity.js')
			  }
		})
		.when('/activity/groupBuy', { templateUrl: "views/activity/groupBuy.html?"+preventCache
			  ,resolve: {
				load: app.asyncjs('js/controller/activity/activity.js')
			  }
		 })
		.when('/activity/tour', { templateUrl: "views/activity/tour.html?"+preventCache
			  ,resolve: {
				load: app.asyncjs('js/controller/activity/activity.js')
			  }
		})
		.when('/activity/tangcun', { templateUrl: "views/activity/tangcun.html?"+preventCache
			  ,resolve: {
				load: app.asyncjs('js/controller/activity/activity.js')
			  }
		})
		.when('/activity/beautyLife', { templateUrl: "views/activity/beautyLife.html?"+preventCache
			  ,resolve: {
				load: app.asyncjs('js/controller/activity/activity.js')
			  }
		})
		.when('/activity/twGift', { templateUrl: "views/activity/twGift_2.html?"+preventCache
			  ,resolve: {
				load: app.asyncjs('js/controller/activity/activityDown.js')
			  }
		})
		.when('/activity/twGift_3', { templateUrl: "views/activity/twGift_3.html?"+preventCache
			  ,resolve: {
				load: app.asyncjs('js/controller/activity/activityDown.js')
			  }
		})
...
app.controller('mainController', function ($rootScope, $window, $scope, httpRequest,dataStringify, analytics) {
	...
	$rootScope.initNav=function(cat){
        ...
        lis=lis+"<a href=\"#/products\">首页</a></li>";
        var liCount=1;
        $rootScope.categoryIndex=1;
