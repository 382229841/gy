app.register.controller('activityCardController', function ($rootScope, $scope, httpRequest, dataStringify, signSha1, analytics, $location, $window, $routeParams) {
    //window.ontouchstart = function(e) { e.preventDefault(); };
    $scope.isShowNavbar=false;
    $scope.isApp=isApp($location);
    $scope.isShowNavbar=$scope.isApp?false:true;

    var link="http://goeasy.yhiker.com/kr/#/activity/card?source=3&sharedTo=";
    var imgUrl="http://goeasy.yhiker.com/kr/image/activity/card/1.jpg";
    var title="购轻松韩国";
    var desc="一卡在手，韩国任我走";
...
app.register.controller('dutyFreeController', function ($rootScope, $scope, httpRequest, dataStringify, signSha1, analytics, $location, $window, $routeParams) {
    //window.ontouchstart = function(e) { e.preventDefault(); };
    $scope.isShowNavbar=false;
    $scope.isApp=isApp($location);
    $scope.isShowNavbar=$scope.isApp?false:true;

    var link="http://goeasy.yhiker.com/kr/#/activity/dutyFree?source=3&sharedTo=";
    var imgUrl="http://goeasy.yhiker.com/kr/image/activity/dutyFree/1.jpg";
    var title="购轻松韩国";
    var desc="挑战免税店";
